...
[Def_FLTPrelim_GaloisRep.lean, lines 74–77](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_GaloisRep.lean#L74-L77))
...
([Def_FLTPrelim_CofixedLine.lean, lines 13–18](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_CofixedLine.lean#L13-L18)):
...
2. **"Line" is only a name.** No rank condition is imposed. In the intended
   ...
   [Thm_WeierstrassCurve_card_torsion_of_isAlgClosed.lean, line 9](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_card_torsion_of_isAlgClosed.lean#L9)),
...
([S_FreyPackage_frey_reducible_hasCofixedLine.lean, lines 43–52](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_reducible_hasCofixedLine.lean#L43-L52)):
...
[Thm_FreyPackage_frey_torsion_fixed_eq_zero.lean, line 8](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_torsion_fixed_eq_zero.lean#L8),
reducing to
[`FreyPackage.freyCurve_rational_p_torsion_eq_zero`, line 7](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_freyCurve_rational_p_torsion_eq_zero.lean#L7)).
...
imports exactly
([S_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean, lines 1–7](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean#L1-L7))
...
([Thm_FreyPackage_Mazur_Frey.lean, line 70](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_Mazur_Frey.lean#L70)),
is exactly that argument, run in two cases
([S_FreyPackage_Mazur_Frey.lean, lines 77–91](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_Mazur_Frey.lean#L77-L91)):
...
|---|---|---|
| $a \equiv 3 \pmod 8$ | `frey_no_cofixed_of_a_mod_eight` ([line 12](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_no_cofixed_of_a_mod_eight.lean#L12)) | its own argument at the prime $2$; the same shape: `by_contra` → cofixed line → contradiction ([S_FreyPackage_Mazur_Frey_of_a_mod_eight.lean, lines 14–19](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_Mazur_Frey_of_a_mod_eight.lean#L14-L19)) |
| $p \in \{5, 7, 13\}$ | `frey_no_cofixed_small` ([line 13](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_no_cofixed_small.lean#L13)) | **vacuous**: FLT for these exponents is already proved, so $P$ cannot exist ([S file, lines 27–29](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_no_cofixed_small.lean#L27-L29)) |
| $p = 11$ | `frey_no_cofixed_eleven` ([line 13](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_no_cofixed_eleven.lean#L13)) | likewise vacuous, via `fermatLastTheoremEleven` |
| $p \geq 17$ | `frey_no_cofixed_large` ([line 70](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_no_cofixed_large.lean#L70)) | the real content: Mazur's Eisenstein-ideal argument (PROOF-PATH.md, step 3) |
...
([Def_FLTPrelim_CofixedLine.lean, lines 1–2](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_CofixedLine.lean#L1-L2)).
...
([Def_FreyPackage_GaloisRep.lean, lines 18–21](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FreyPackage_GaloisRep.lean#L18-L21));
`FreyPackage.freyGaloisRep` (lines 38–42) is the Frey-curve instantiation.
The `End`-valued twin `galoisRepModuleEnd`
([Def_EllipticCurve_FrobeniusTrace.lean, lines 25–27](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_EllipticCurve_FrobeniusTrace.lean#L25-L27),
...
- on a cofixed line, $\sigma$ acts on $N$ **by the scalar $\det \sigma$** —
  ...
  ([Thm_WeierstrassCurve_smul_eq_det_smul_of_cofixed.lean, lines 10–21](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_smul_eq_det_smul_of_cofixed.lean#L10-L21));
- $\det \sigma$ is the mod-$`p`$ **cyclotomic character** — on $p$-power roots
  ...
  [line 10](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_apply_eq_pow_det_galoisRep_of_pow_eq_one.lean#L10));
...
([Def_GaloisRep_Residual.lean, lines 22–32](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_GaloisRep_Residual.lean#L22-L32))
...
[Def_EllipticCurve_TateModule.lean, lines 596–630](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_EllipticCurve_TateModule.lean#L596-L630)),
...
newvectors
([Def_AdelicDock_LocalEmbedding.lean](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_AdelicDock_LocalEmbedding.lean)).
...
([S_WeierstrassCurve_residualGaloisRepOf_isIrreducible_iff.lean, line 12](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_WeierstrassCurve_residualGaloisRepOf_isIrreducible_iff.lean#L12)):
...
|---|---|---|
| cofixed line, in English | proper nonzero stable $\mathbb{Z}/n$-submodule $N \subseteq M = (W'/K).Point[n]$ with $\sigma \cdot x - x \in N$ for all $x \in M$ — trivial action on $M/N$ | [Def_FLTPrelim_CofixedLine.lean, lines 15–18](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_CofixedLine.lean#L15-L18) |
| "line" is only a name | no rank hypothesis; order $p$ follows from $M$ having $p^2$ elements when needed | Def_FLTPrelim_CofixedLine.lean:15–18; [Thm_WeierstrassCurve_card_torsion_of_isAlgClosed.lean, line 9](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_card_torsion_of_isAlgClosed.lean#L9) |
| reducible ⇒ cofixed | negating irreducibility gives stable $N$; Frey dichotomy: $N$ fixed or cofixed; fixed dies (no rational $p$-torsion) | [Thm_FreyPackage_frey_reducible_hasCofixedLine.lean, line 15](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_reducible_hasCofixedLine.lean#L15); [S file, lines 43–52](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_reducible_hasCofixedLine.lean#L43-L52) |
| the dichotomy is Frey-specific | unramified away from $2p$; inertia at $2$ trivial on $N$; inertia at $p$ trivial on $N$ or $M/N$ | [Thm_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean, line 10](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean#L10); [S file imports, lines 1–7](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean#L1-L7) |
| `Mazur_Frey` = no cofixed line | case split $a \equiv 3 \pmod 8$ (own 2-adic argument) + trichotomy $p \in \{5,7,13\}$ / $11$ (vacuous) / $\geq 17$ (Eisenstein ideal) | [Thm_FreyPackage_Mazur_Frey.lean, line 70](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_Mazur_Frey.lean#L70); [S file, lines 77–91](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_Mazur_Frey.lean#L77-L91) |
| Layer 0: bare submodules | predicates quantify over submodules/points; no `Representation`, no basis, no `hcard` in the cofixed module | [Def_FLTPrelim_CofixedLine.lean, lines 1–2, 15–18](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_CofixedLine.lean#L1-L2) |
| Layer 1: `End`-hom; $\det$ the only "character" | `galoisRep`/`galoisRepModuleEnd` repackage the action basis-free; $\sigma\|_N = \det \sigma$; $\det \sigma$ = mod-$p$ cyclotomic | [Def_FreyPackage_GaloisRep.lean, lines 18–21](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FreyPackage_GaloisRep.lean#L18-L21); [Def_EllipticCurve_FrobeniusTrace.lean, lines 25–27](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_EllipticCurve_FrobeniusTrace.lean#L25-L27); [Thm_WeierstrassCurve_smul_eq_det_smul_of_cofixed.lean, lines 10–21](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_smul_eq_det_smul_of_cofixed.lean#L10-L21); [Thm_WeierstrassCurve_apply_eq_pow_det_galoisRep_of_pow_eq_one.lean, line 10](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_apply_eq_pow_det_galoisRep_of_pow_eq_one.lean#L10) |
| Layers 2–3: the real $\bar\rho$, matrices never taken | `ResidualGaloisRep` (`finrank = 2` from explicit `hcard`) buys charpoly/det basis-free; basis machinery exists but `GL (Fin 2)` is automorphic-only; the worlds tied by `residualGaloisRepOf_isIrreducible_iff` | [Def_GaloisRep_Residual.lean, lines 22–32, 87–88](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_GaloisRep_Residual.lean#L22-L32); [Def_EllipticCurve_TateModule.lean, lines 596–630](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_EllipticCurve_TateModule.lean#L596-L630); [S_WeierstrassCurve_residualGaloisRepOf_isIrreducible_iff.lean, line 12](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_WeierstrassCurve_residualGaloisRepOf_isIrreducible_iff.lean#L12) |

## 6. Links

Lean sources (raw; quote line numbers as above):

- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_CofixedLine.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_GaloisRep.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_EllipticCurve_FrobeniusTrace.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_GaloisRep_Residual.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FreyPackage_GaloisRep.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_EllipticCurve_TateModule.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_AdelicDock_LocalEmbedding.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_Mazur_Frey.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_Mazur_Frey_of_a_mod_eight.lean>
...
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_torsion_fixed_eq_zero.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_freyCurve_rational_p_torsion_eq_zero.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_no_cofixed_small.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_no_cofixed_eleven.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_no_cofixed_large.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_no_cofixed_of_a_mod_eight.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_smul_eq_det_smul_of_cofixed.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_apply_eq_pow_det_galoisRep_of_pow_eq_one.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_card_torsion_of_isAlgClosed.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_Mazur_Frey.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_reducible_hasCofixedLine.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_WeierstrassCurve_residualGaloisRepOf_isIrreducible_iff.lean>
