...
([Thm_FreyPackage_freyCurveInt_map.lean](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_freyCurveInt_map.lean#L17-L46);
proof in
[S_FreyPackage_freyCurveInt_map.lean, lines 17–46](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyCurveInt_map.lean#L17-L46)).
...
[Def_FLTPrelim_Modularity.lean, lines 88–90](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_Modularity.lean#L88-L90))
...
1. `FreyCurve.Δ`,
   [Def_FreyCurve_Basic.lean, lines 9–15](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FreyCurve_Basic.lean#L9-L15)
...
2. `FreyPackage.freyCurve_discriminant`,
   [Thm_FreyPackage_freyCurve_discriminant.lean](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_freyCurve_discriminant.lean)
   + [S_FreyPackage_freyCurve_discriminant.lean](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyCurve_discriminant.lean)
...
3. `FreyArith.freyCurve_Δ`,
   [S_FreyPackage_freyCurveInt_map.lean, lines 48–55](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyCurveInt_map.lean#L48-L55)
...
(The first two are
[`FreyCurve.b₂`, `FreyCurve.b₄`](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FreyCurve_Basic.lean),
...
[`FreyCurve.c₄`](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FreyCurve_Basic.lean)
...
- **Ellipticity**: $\Delta$ is a unit of ℚ because $abc \ne 0$ — the
  ...
  ([Def_FreyCurve_Basic.lean, lines 18–23](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FreyCurve_Basic.lean#L18-L23)),
...
- **Semistability**: `FreyPackage.frey_isSemistableModel : P.freyCurveInt.IsSemistableModel`,
  ...
  ([Def_FLTPrelim_Modularity.lean, lines 85–87](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_Modularity.lean#L85-L87)).
  The arithmetic input is `FreyArith.not_dvd_c₄Int`
  ([S_FreyPackage_freyCurveInt_map.lean, lines 71–98](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyCurveInt_map.lean#L71-L98)):
...
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FreyCurve_Basic.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_FreyPackage.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_Modularity.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_freyCurve_discriminant.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyCurve_discriminant.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyCurveInt_map.lean>
