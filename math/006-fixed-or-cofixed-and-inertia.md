...
([Thm_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean, line 10](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean#L10)):
...
([S_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean, lines 33–55](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean#L33-L55)):
...
1. Branch on a dichotomy <i>localized at the prime $`p`$</i>: inertia at $`p`$ acts
   ...
   [Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean#L11)).
2. In each branch, **close globally**: to show *all* of
   ...
   **inertia-triviality at every prime $`q`$**
   ...
   [Thm, line 8](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galois_action_trivial_on_submodule_of_inertia_trivial.lean#L8);
   `..._on_quotient_of_inertia_trivial`,
   [Thm, line 8](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galois_action_trivial_on_quotient_of_inertia_trivial.lean#L8)).
   ...
   - $`q \neq 2, p`$: `freyGaloisRep_isUnramifiedAt`
     ([Thm, line 15](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_freyGaloisRep_isUnramifiedAt.lean#L15))
...
([Thm, line 5](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_Submodule_stableLine_fixed_or_cofixed_of_absorbing.lean#L5)).
...
([S file, lines 25–46](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_Submodule_stableLine_fixed_or_cofixed_of_absorbing.lean#L25-L46))
...
([S_FreyPackage_freyGaloisRep_isUnramifiedAt.lean, `freyGaloisRep_isUnramifiedAt_of_local_criteria`, lines 146–176](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyGaloisRep_isUnramifiedAt.lean#L146-L176))
on the integral model `freyCurveInt`:

- **$`q \nmid abc`$ (good reduction):** then $`q \nmid \Delta`$ and
  `galoisRepUnramifiedAt_of_goodReduction`
  ([Thm, line 12](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galoisRepUnramifiedAt_of_goodReduction.lean#L12))
...
- **$`q \mid abc`$ (bad reduction):** two Frey-specific computations:
  ...
  **multiplicative**; and
  ...
  ([Thm, line 12](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galoisRepUnramifiedAt_of_multiplicativeReduction.lean#L12))
...
([Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient_at.lean#L11))
produces the absorbing $`M`$ of §2 for the inertia group at one fixed place
$`A`$ over $`p`$, again by cases
([S file, lines 32–34](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient_at.lean#L32-L34)):

- **$`p \nmid abc`$ (good reduction at $`p`$):**
  `frey_inertia_at_p_filtration_of_not_dvd_abc`
  ([Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_filtration_of_not_dvd_abc.lean#L11)).
  ...
  [Thm, line 8](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_exists_reductionKernel_absorbing_inertia.lean#L8));
  ...
  ([Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_exists_p_torsion_integral_abscissa.lean#L11)).
...
- **$`p \mid abc`$ (multiplicative reduction at $`p`$):**
  ...
  ([Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_filtration_of_dvd_abc_of_stable_line.lean#L11)).
  ...
  [Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_exists_torsion_zeroComponent_submodule_of_multiplicativeReduction.lean#L11);
  `InZeroComponentAt` is $`O`$, or a pole at $`A`$, or a point reducing to the
  node,
  [Def_EllipticCurve_ZeroComponentAt.lean, lines 13–19](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_EllipticCurve_ZeroComponentAt.lean#L13-L19)).
  ...
  [Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_inZeroComponentAt_smul_sub_of_mem_inertiaSubgroupIn.lean#L11));
  ...
  [Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_inZeroComponentAt_torsionBy_residueChar.lean#L11)),
  while the stable line again
  supplies an integral-abscissa point
  (`frey_exists_p_torsion_integral_abscissa_of_stable_line`,
  [Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_exists_p_torsion_integral_abscissa_of_stable_line.lean#L11)).
...
ingredients
([S_FreyPackage_frey_inertia_at_two_trivial_on_stable_submodule.lean, lines 167–175](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_two_trivial_on_stable_submodule.lean#L167-L175)):
...
1. **The tame relation.** Local class field structure: for $`\tau`$ in
   ...
   [Thm, line 8](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_ValuationSubring_exists_algEquiv_conj_mul_pow_inv_wild_of_liesOverPrime.lean#L8)).
2. **Wild inertia acts trivially on $`E_P[p]`$.** Wild inertia is a
   ...
   [Thm, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_wild_inertia_at_two_trivial.lean#L11)):
   ...
   [S file, solution at line 520](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_wild_inertia_at_two_trivial.lean#L520)).
...
([S file, line 18](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_two_trivial_on_stable_submodule.lean#L18))
...
[S_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean, line 42](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean#L42)).
...
([Thm, line 6](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_AlgebraicClosure_subgroup_eq_top_of_inertiaSubgroupIn_le.lean#L6)):
...
[Thm, line 5](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_NumberField_subgroup_eq_top_of_forall_inertia_le.lean#L5);
[S file, lines 36–54](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_NumberField_subgroup_eq_top_of_forall_inertia_le.lean#L36-L54)).
...
[S_WeierstrassCurve_galois_action_trivial_on_submodule_of_inertia_trivial.lean, lines 14–46](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_WeierstrassCurve_galois_action_trivial_on_submodule_of_inertia_trivial.lean#L14-L46)).
...
[Thm, line 7](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_ValuationSubring_exists_algEquiv_smul_eq_of_liesOverPrime.lean#L7)),
...
([S file, lines 96–112](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean#L96-L112)).
...
|---|---|---|
| the dichotomy | stable $`N \subset E_P[p]`$, $`N \neq \bot, \top`$ ⇒ pointwise fixed or cofixed | [Thm_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean, line 10](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean#L10) |
| global assembly | branch on the $`p`$-dichotomy; close by prime-wise inertia check ($`2`$ / $`p`$ / unramified) | [S_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean, lines 33–55](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean#L33-L55) |
| linear core | $`\mathrm{card}\,V = p^2`$; absorbing $`M`$; $`N = M`$ ⇒ cofixed, $`N \cap M = \bot`$ ⇒ fixed | [Thm_Submodule_stableLine_fixed_or_cofixed_of_absorbing.lean, line 5](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_Submodule_stableLine_fixed_or_cofixed_of_absorbing.lean#L5); [S, lines 25–46](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_Submodule_stableLine_fixed_or_cofixed_of_absorbing.lean#L25-L46) |
| unramified away from $`2p`$ | good: NOS; multiplicative: $`q \nmid c_4`$ (coprimality), $`p \mid v_q(\Delta)`$ (the $`p`$-th powers) | [Thm_FreyPackage_freyGaloisRep_isUnramifiedAt.lean, line 15](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_freyGaloisRep_isUnramifiedAt.lean#L15); [S, lines 146–176 (`not_dvd_c₄Int`, line 70, `padicValInt_freyCurveInt_Δ`, line 130)](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyGaloisRep_isUnramifiedAt.lean#L146-L176) |
| absorbing line at $`p`$, good case | $`\Delta`$ a unit in $`A`$; reduction kernel absorbs inertia; integral-abscissa point ⇒ $`M \neq \top`$ | [Thm_FreyPackage_frey_inertia_at_p_filtration_of_not_dvd_abc.lean, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_filtration_of_not_dvd_abc.lean#L11); [Thm_WeierstrassCurve_exists_reductionKernel_absorbing_inertia.lean, line 8](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_exists_reductionKernel_absorbing_inertia.lean#L8) |
| absorbing line at $`p`$, multiplicative case | zero-component ($`\mu_p`$) torsion absorbs inertia; $`p`$-torsion in it is $`O`$ or non-integral ⇒ $`M \neq \top`$ | [Thm_FreyPackage_frey_inertia_at_p_filtration_of_dvd_abc_of_stable_line.lean, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_filtration_of_dvd_abc_of_stable_line.lean#L11); [Thm_WeierstrassCurve_exists_torsion_zeroComponent_submodule_of_multiplicativeReduction.lean, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_exists_torsion_zeroComponent_submodule_of_multiplicativeReduction.lean#L11); [Thm_WeierstrassCurve_inZeroComponentAt_smul_sub_of_mem_inertiaSubgroupIn.lean, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_inZeroComponentAt_smul_sub_of_mem_inertiaSubgroupIn.lean#L11) |
| one place ⇒ all places at $`p`$ | $`\Gamma`$ transitive on valuation subrings over $`p`$; inertia conjugation-covariant; branch independent of place | [Thm_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean#L11); [Thm_ValuationSubring_exists_algEquiv_smul_eq_of_liesOverPrime.lean, line 7](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_ValuationSubring_exists_algEquiv_smul_eq_of_liesOverPrime.lean#L7); [S, line 64, 96–112](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean#L64) |
| inertia at $`2`$ unipotent on any stable flag | wild trivial (pro-$`2`$ on odd torsion; direct 2-adic valuation analysis); tame relation ⇒ $`c = c^2`$ on line and quotient | [Thm_FreyPackage_frey_inertia_at_two_trivial_on_stable_submodule.lean, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_two_trivial_on_stable_submodule.lean#L11); [Thm_FreyPackage_frey_wild_inertia_at_two_trivial.lean, line 11](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_wild_inertia_at_two_trivial.lean#L11); [`eq_id_on_line_of_conj_eq_sq`, S, line 18](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_two_trivial_on_stable_submodule.lean#L18) |
| inertia generates the Galois group | open subgroup containing all inertia is ⊤; openness from finiteness of $`E[p]`$; Minkowski | [Thm_AlgebraicClosure_subgroup_eq_top_of_inertiaSubgroupIn_le.lean, line 6](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_AlgebraicClosure_subgroup_eq_top_of_inertiaSubgroupIn_le.lean#L6); [Thm_NumberField_subgroup_eq_top_of_forall_inertia_le.lean, line 5](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_NumberField_subgroup_eq_top_of_forall_inertia_le.lean#L5); [mathlib ExistsRamified.lean:41, v4.33.0](https://github.com/leanprover-community/mathlib4/blob/v4.33.0/Mathlib/NumberTheory/NumberField/ExistsRamified.lean) |
| closure lemmas | inertia-trivial at all primes on $`N`$ (resp. $`M/N`$) ⇒ globally trivial | [Thm_..._on_submodule_of_inertia_trivial.lean, line 8](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galois_action_trivial_on_submodule_of_inertia_trivial.lean#L8); [Thm_..._on_quotient_of_inertia_trivial.lean, line 8](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galois_action_trivial_on_quotient_of_inertia_trivial.lean#L8) |
| where it is used | fixed branch dies (no rational $`p`$-torsion); cofixed branch = `HasGaloisStableCofixedLine` | note 004 §2; [Thm_FreyPackage_frey_reducible_hasCofixedLine.lean, line 15](https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_reducible_hasCofixedLine.lean#L15) |

## 6. Links

Lean sources (raw; quote line numbers as above):

- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_FLTPrelim_Ramification.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Definitions/Def_EllipticCurve_ZeroComponentAt.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_freyGaloisRep_isUnramifiedAt.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_two_trivial_on_stable_submodule.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient_at.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_filtration_of_dvd_abc_of_stable_line.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_inertia_at_p_filtration_of_not_dvd_abc.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_wild_inertia_at_two_trivial.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_exists_p_torsion_integral_abscissa.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_FreyPackage_frey_exists_p_torsion_integral_abscissa_of_stable_line.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_Submodule_stableLine_fixed_or_cofixed_of_absorbing.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galois_action_trivial_on_submodule_of_inertia_trivial.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galois_action_trivial_on_quotient_of_inertia_trivial.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galoisRepUnramifiedAt_of_goodReduction.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_galoisRepUnramifiedAt_of_multiplicativeReduction.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_exists_reductionKernel_absorbing_inertia.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_exists_torsion_zeroComponent_submodule_of_multiplicativeReduction.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_WeierstrassCurve_inZeroComponentAt_smul_sub_of_mem_inertiaSubgroupIn.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_AlgebraicClosure_subgroup_eq_top_of_inertiaSubgroupIn_le.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_NumberField_subgroup_eq_top_of_forall_inertia_le.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_ValuationSubring_exists_algEquiv_smul_eq_of_liesOverPrime.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/Theorems/Thm_ValuationSubring_exists_algEquiv_conj_mul_pow_inv_wild_of_liesOverPrime.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_stable_submodule_fixed_or_cofixed.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_p_trivial_on_submodule_or_quotient_at.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_inertia_at_two_trivial_on_stable_submodule.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_frey_wild_inertia_at_two_trivial.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_FreyPackage_freyGaloisRep_isUnramifiedAt.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_Submodule_stableLine_fixed_or_cofixed_of_absorbing.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_AlgebraicClosure_subgroup_eq_top_of_inertiaSubgroupIn_le.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_NumberField_subgroup_eq_top_of_forall_inertia_le.lean>
- <https://github.com/anthropics/fermats-last-theorem/blob/aa2d8b3/P2M/Sol/S_WeierstrassCurve_galois_action_trivial_on_submodule_of_inertia_trivial.lean>
